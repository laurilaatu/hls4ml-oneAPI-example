...
struct config3 : nnet::dense_config {
    ...
    static constexpr weight_t weights = w3;
    static constexpr bias_t biases = b3;
...
struct config6 : nnet::dense_config {
    ...
    static constexpr weight_t weights = w6;
    static constexpr bias_t biases = b6;
...
struct config9 : nnet::dense_config {
    ...
    static constexpr weight_t weights = w9;
    static constexpr bias_t biases = b9;
...
struct config12 : nnet::dense_config {
    ...
    static constexpr weight_t weights = w12;
    static constexpr bias_t biases = b12;
