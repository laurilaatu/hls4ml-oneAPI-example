...
struct config2 : nnet::conv1d_config {
    ...
    static const unsigned impl_filt_width = 5;
...
struct relu_config3 : nnet::activ_config {
    static constexpr unsigned n_in = 20;
    ...
    typedef conv1d_3_relu_table_t table_t;
};
...
struct config4 : nnet::gru_config {
    ...
    static const unsigned n_timesteps = 5;
    static const unsigned n_outputs = 5;
    static const bool return_sequences = true;
