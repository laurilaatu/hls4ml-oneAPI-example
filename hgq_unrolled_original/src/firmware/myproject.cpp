...
void Myproject::operator()() const {
    ...
    nnet::dense_resource<input_layer_t, q_dense_t, config3>(input_layer, layer3_out, w3, b3);
    ...
    nnet::dense_resource<q_dense_1_iq_t, q_dense_1_t, config6>(layer5_out, layer6_out, w6, b6);
    ...
    nnet::dense_resource<q_dense_2_iq_t, q_dense_2_t, config9>(layer8_out, layer9_out, w9, b9);
    ...
    nnet::dense_resource<q_dense_3_iq_t, result_t, config12>(layer11_out, layer12_out, w12, b12);
