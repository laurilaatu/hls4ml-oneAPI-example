...
typedef nnet::array<ac_fixed<28,16,true>, 4*1> conv1d_result_t;
...
typedef nnet::array<ac_fixed<12,6,true>, 16*1> layer5_t;
typedef nnet::array<ac_fixed<12,6,true>, 768*1> w5_t;
typedef nnet::array<ac_fixed<12,6,true>, 768*1> wr5_t;
typedef nnet::array<ac_fixed<12,6,true>, 48*1> b5_t;
typedef nnet::array<ac_fixed<12,6,true>, 48*1> br5_t;
typedef ac_fixed<18,8,true> gru_1_table_t;
typedef nnet::array<ac_fixed<29,17,true>, 5*1> result_t;
typedef nnet::array<ac_fixed<12,6,true>, 80*1> w6_t;
typedef nnet::array<ac_fixed<12,6,true>, 5*1> b6_t;
