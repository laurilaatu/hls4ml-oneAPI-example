...
class MyprojectClassFloat_98e43a3a;
...
void myproject_float(
    ...
    q.single_task<MyprojectClassFloat_98e43a3a>(Myproject{});
    nnet::convert_data_back<Layer6OutPipe, float, N_LAYER_6>(q, layer6_out);

    q.wait();
}

class MyprojectClassDouble_98e43a3a;
...
void myproject_double(
    ...
    q.single_task<MyprojectClassDouble_98e43a3a>(Myproject{});
    nnet::convert_data_back<Layer6OutPipe, double, N_LAYER_6>(q, layer6_out);
